...
![](http://www.varygod.top/Shadowsocks.jpg)
<!--more-->
...
![enter image description here](http://www.varygod.top/1.png)


注意，如果点进去的支付方案显示**out of stock**，说明该种方案的VPS**暂时缺货**。请选择其他方案的VPS。

![enter image description here](http://www.varygod.top/2.png)

点击**Add to Cart(添加到购物车)**后，进入订单确认页面。这里可以输入**优惠码**得到优惠。如下图所示：

![enter image description here](http://www.varygod.top/3.png)


搬瓦工的优惠码都是终身的优惠码，可以看到续费也是同价。核对我们选择的方案和价格，没有问题后点击**Checkout**结账。

![enter image description here](http://www.varygod.top/4.png)
...
![enter image description here](http://www.varygod.top/5.png)

 如果选择支付宝(Alipay)付款的话，便会进入到这一步。

 ![enter image description here](http://www.varygod.top/6.png)

 之后点击"**Pay Now**"，就会弹出支付宝支付窗口，进行支付即可。

 ![enter image description here](http://www.varygod.top/7.png)

支付成功后，便会得到以下的界面，其中VPS的SSH端口和root密码也会发送到您填写的邮箱中。点击**Click here to go to your Client Area**，进入管理页面。

![enter image description here](http://www.varygod.top/8.png)

若没在登录状态，进入官网，右上角点击"**Client Area**"进行登录。依次点击"Service"->"My Service"就可以进入到已购买的VPS列表页。

![enter image description here](http://www.varygod.top/9.png)


 登陆搬瓦工账户后台，就可以看到已经成功买到的VPS主机，我们可以点击**KiwiVM Control Panel**登录管理面板进行VPS的管理和使用。

 ![enter image description here](http://www.varygod.top/10.png)
...
![enter image description here](http://www.varygod.top/11-1.png)


然后，在源码中按下**Ctrl+F** ， 查找关键字：**promo code**   就可以看到最新可以使用的优惠码了。

![enter image description here](http://www.varygod.top/11.png)
...
![enter image description here](http://www.varygod.top/12.png)


跳转到控制面板页面，我们先来熟悉一下这里展示的服务器信息。如下图：

![enter image description here](http://www.varygod.top/13.png)

服务器的准备工作
安装CentOS系统

![enter image description here](http://www.varygod.top/14.png)
...
![enter image description here](http://www.varygod.top/15.png)


如果停止VPS成功了之后，会看到下图的界面：

![enter image description here](http://www.varygod.top/16.png)
...
![enter image description here](http://www.varygod.top/17.png)

如果点完按钮之后，出现如下图的界面：

![enter image description here](http://www.varygod.top/18.png)

这是因为VPS没有停止。请执行上一步，关闭VPS。
如果出现下图所示，说明重装系统已经完成。

![enter image description here](http://www.varygod.top/19.png)
...
![enter image description here](http://www.varygod.top/20.png)
...
![enter image description here](http://www.varygod.top/21.png)

**【方法二】**

点击控制面板左侧的【**Root shell - interactive**】按钮，再点击右侧区域的【**Launch**】按钮，浏览器会再弹出一个网页。在新的网页中输入shell命令passwd，点击回车键。如下图：

![enter image description here](http://www.varygod.top/22.png)

输入您要设置的新密码，这时输入密码的同时屏幕上不会显示你的输入。输入完成后，点击回车。如下图：

![enter image description here](http://www.varygod.top/23.png)


然后再输入一遍新密码，点击回车。修改密码成功，如下图：

![enter image description here](http://www.varygod.top/24.png)
...
![enter image description here](http://www.varygod.top/25.png)

点击 “用户身份验证”，输入用户名（默认root）和密码。确认

![enter image description here](http://www.varygod.top/26.png)

连接 VPS，接受并保存密匙。

![enter image description here](http://www.varygod.top/27.png)


![enter image description here](http://www.varygod.top/28.png)

出现 root@vultr:~# 即连接成功。

![enter image description here](http://www.varygod.top/29.png)
...
![enter image description here](http://www.varygod.top/30.png)
...
![enter image description here](http://www.varygod.top/31.png)

如上图出现管理界面后，输入数字1来安装SSR服务端。如果输入1后不能进入下一步，那么请退出xshell，重新连接vps服务器，然后输入快捷管理命令bash ssr.sh 再尝试。

![enter image description here](http://www.varygod.top/32.png)
...
![enter image description here](http://www.varygod.top/33.png)
...
![enter image description here](http://www.varygod.top/34.png)
...
![enter image description here](http://www.varygod.top/35.png)


2、找到左侧的Shadowsocks server，出现如下画面，点击安装


![enter image description here](http://www.varygod.top/36.png)


3、安装很快，基本不到1分钟就可以完成，出现如下画面，点击返回

![enter image description here](http://www.varygod.top/37.png)


4、好了，就可以看到自己的SS信息了。如果想修改，还可以点后面的按钮修改。

![enter image description here](http://www.varygod.top/38.png)
...
![enter image description here](http://www.varygod.top/39.png)


然后就可以看到SS安装界面了，如下图

![enter image description here](http://www.varygod.top/40.png)


2、点击安装就可以了。安装很快，基本不到1分钟就可以完成，出现如下画面，点击返回

![enter image description here](http://www.varygod.top/41.png)


3、好了，就可以看到自己的SS信息了。如果想修改，还可以点后面的按钮修改。

![enter image description here](http://www.varygod.top/42.png)
...
![enter image description here](http://www.varygod.top/43.png)
...
![enter image description here](http://www.varygod.top/44.png)
...
![enter image description here](http://www.varygod.top/45.png)

![enter image description here](http://www.varygod.top/46.png)

3、MAC客户端

![enter image description here](http://www.varygod.top/47.png)


# 5.效果测试 #
打开Google

![enter image description here](http://www.varygod.top/49.png)

打开instagram

![enter image description here](http://www.varygod.top/50.png)

打开YouTube 1080P 无卡顿

![enter image description here](http://www.varygod.top/48.png)

打开Twitter

![enter image description here](http://www.varygod.top/51.png)
